...
$sendto   = "info@aloriya-sobinova.com"; // почта, на которую будет приходить письмо
...
$subject  = "Обратный звонок https://aloriya-sobinova.com/diagnostika-nv-web/";
$from = '=?UTF-8?B?' . base64_encode('https://aloriya-sobinova.com/gs-mk/');
...
$msg .= "<h2 style='font-weight:bold;border-bottom:1px dotted #ccc;'>Лендинг https://aloriya-sobinova.com/gs-mk/</h2>\r\n";
...
if(@mail($sendto, $subject, $msg, $headers)) {
      ...
      echo "<center><a href='https://aloriya-sobinova.com/gs-mk/'>Вернуться на сайт</a></center>";
} else {
